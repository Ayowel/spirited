...
{% include gif.html name="example_simple_ce3ade05" %}
...
{% include gif.html name="example_cursor_interaction_b19f8a8c" %}
...
{% include gif.html name="example_rain_bb8c9c3d" %}
...
{% include gif.html name="example_image_simple_05fa914d" %}
...
{% include gif.html name="example_image_multi_0210a899" %}
...
{% include gif.html name="example_spawn_guideline_1212320d" %}
